...
/**
 * Pruebas de rutas V2 para vehiculos con HATEOAS.
 */
@WebMvcTest(VehiculoControllerV2.class)
@Import({GlobalExceptionHandler.class, VehiculoModelAssembler.class})
@ActiveProfiles("test")
class VehiculoControllerV2Test {
    ...
    @Test
    void testBuscarDisponiblesPorPrecioMenorV2() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/vehiculos/disponibles/precio-menor/50000"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$._links.self.href").exists());
